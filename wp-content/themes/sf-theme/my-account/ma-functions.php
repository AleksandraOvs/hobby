...
// 1️⃣ Добавляем вкладку в меню ЛК
add_filter('woocommerce_account_menu_items', function ($items) {
    $items['discount'] = 'Моя скидка'; // добавляем вкладку
    return $items;
}, 20);

// 2️⃣ Регистрируем endpoint для вкладки
add_action('init', function () {
    add_rewrite_endpoint('discount', EP_PAGES);
});

// 3️⃣ Выводим контент вкладки через шаблон
add_action('woocommerce_account_discount_endpoint', function () {

    // Генерируем контент шорткода
    $discount_content = do_shortcode('[user_discount_ranges]');

    // Подключаем кастомный шаблон (можно положить в yourtheme/woocommerce/myaccount/discount.php)
    wc_get_template(
        'myaccount/discount.php',
        ['discount_content' => $discount_content] // передаем переменную в шаблон
    );
});
...
<path d="M11.9385 0C18.5314 0.000249454 23.876 5.34545 23.876 11.9385C23.8757 18.5313 18.5313 23.8757 11.9385 23.876C5.34545 23.876 0.000252025 18.5314 0 11.9385C0 5.34529 5.34529 0 11.9385 0ZM18.1035 14.457C18.0332 12.957 16.6793 11.6715 15.0205 11.9277C14.1872 12.0563 13.5963 12.5138 13.249 12.9824C12.7689 13.6301 12.6766 14.2816 12.7197 15.2422C12.7523 15.9682 13.1022 16.6827 13.6328 17.1514C14.7943 18.177 16.6183 18.0056 17.5752 16.7285C18.066 16.0732 18.1496 15.4452 18.1035 14.457ZM16.1494 7.91016C16.3913 7.21775 15.7421 6.51604 15.041 6.69141C14.6889 6.77987 14.5547 6.98234 14.374 7.21777L10.2305 12.624C10.0514 12.8568 9.89157 13.0556 9.71094 13.2979C9.4854 13.6005 7.77284 15.7505 7.67773 16.0381C7.43963 16.7664 8.05541 17.4002 8.78711 17.2559C9.13254 17.1878 9.30198 16.9315 9.45996 16.7305C10.9955 14.7708 12.5867 12.6439 14.1162 10.6445C14.3433 10.3476 16.0482 8.19821 16.1494 7.91016ZM15.2969 13.791C15.5743 13.7408 15.8491 13.8818 15.9844 14.0156C16.3328 14.3599 16.2546 15.283 16.1064 15.5332C16.0018 15.71 15.8032 15.8672 15.5664 15.9111C14.9743 16.0207 14.599 15.5601 14.6016 15.0039C14.6046 14.3493 14.6748 13.9036 15.2969 13.791ZM11.1602 8.53125C11.0487 7.05043 9.69767 5.83599 8.01465 6.09375C7.21506 6.21667 6.59853 6.72948 6.28223 7.17578C5.82964 7.81479 5.70561 8.56033 5.78418 9.51367C5.98713 11.9733 9.19382 12.8959 10.666 10.8428C11.1233 10.2049 11.2319 9.48196 11.1602 8.53125ZM8.28613 7.96777C9.43749 7.71748 9.37725 9.29603 9.18262 9.66602C8.83785 10.3209 7.68349 10.2431 7.66309 9.24121C7.65363 8.77104 7.60397 8.1163 8.28613 7.96777Z" fill="#BDBFC1"/>
</svg>
