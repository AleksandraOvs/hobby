...
class RPAEFW_Shipping_Method extends WC_Shipping_Method {
	...
	public $addpackweight;
	public $addpackcost;

	public $cond_min_weight;
	public $cond_max_weight;
	public $cond_has_shipping_class;

	public $fixedvalue_disable;
	public $fixedpackvalue;

	public $time;
	public $add_time;

	public $free_shipping;
	public $free_shipping_custom_title;
	public $free_shipping_hide_if_not_achieved;

	public $class_cost_calc_type;
	public $fee_cost;

	public $force_display;
	public $force_display_info;
